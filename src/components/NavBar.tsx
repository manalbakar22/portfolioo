...
const NavBar = () => {
    ...
    return (
        <div className={`${router.name ? "hidden" : "flex"} z-50 py-3 shadow-2xl shadow-[#6c06f2]/20 w-full sticky top-0 lg:justify-between justify-center lg:gap-0 gap-10 items-center px-14 font-Poppins bg-white`}>
            <h1 className='capitalize font-semibold text-2xl flex items-center text-nowrap mx-3'><Link href={"/"} className='flex justify-center items-center'>Manal BAKAR<span className='text-5xl font-bold text-[#6e06f2]'>.</span></Link></h1>
